...
export const products = [
  {
    id: 1,
    name: 'Atividade Sequências Lógicas - 1º Ano',
    description:
      'Neste arquivo você encontra 5 atividades de sequências lógicas, pensadas para as turmas de 1º ano, para trabalhar a habilidade da BNCC: (EF01MA09) Organizar e ordenar objetos familiares ou representações por figuras, por meio de atributos, tais como cor, forma e medida.',
    image: 'https://i.postimg.cc/4yspm68t/Screenshot-4.png',
    price: 3.5,
    sold: 0,
    linkForSale: 'https://mpago.la/2ABteto',
  },
  {
    id: 2,
